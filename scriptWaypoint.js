...
document.getElementById("googleMaps").addEventListener("click", () => {
  window.open("https://goo.gl/maps/JdJUBJjzyG5Jfv787", "_blank");
});

//2gis.kz/kostanay/firm/70000001035181426

document.getElementById("2GIS").addEventListener("click", () => {
  window.open("https://2gis.kz/kostanay/firm/70000001035181426", "_blank");
});

document.getElementById("yandexMaps").addEventListener("click", () => {
  window.open("https://yandex.kz/maps/org/1003662049/?ll=63.632945%2C53.217915&z=15", "_blank");
});
