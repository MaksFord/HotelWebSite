...
document.getElementById("restLeft").addEventListener("click", () => switchPhotoLeft("radioButtonRest"));
document.getElementById("restRight").addEventListener("click", () => switchPhotoRight("radioButtonRest"));
